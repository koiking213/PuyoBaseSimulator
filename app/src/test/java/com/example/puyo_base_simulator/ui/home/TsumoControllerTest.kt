...
class TsumoControllerTest {
    ...
    fun incrementTsumo() {
        ...
        Truth.assertThat(info.currentColor.second).isEqualTo(PuyoColor.RED)
        Truth.assertThat(info.currentColor.first).isEqualTo(PuyoColor.BLUE)
        Truth.assertThat(info.nextColor.first.first).isEqualTo(PuyoColor.YELLOW)
        Truth.assertThat(info.nextColor.first.second).isEqualTo(PuyoColor.YELLOW)
        Truth.assertThat(info.nextColor.second.first).isEqualTo(PuyoColor.RED)
        Truth.assertThat(info.nextColor.second.second).isEqualTo(PuyoColor.RED)
    ...
    fun decrementTsumo() {
        ...
        val info = tc.makeTsumoInfo()
        Truth.assertThat(info.currentColor.second).isEqualTo(PuyoColor.RED)
        Truth.assertThat(info.currentColor.first).isEqualTo(PuyoColor.GREEN)
        Truth.assertThat(info.nextColor.first.first).isEqualTo(PuyoColor.RED)
        Truth.assertThat(info.nextColor.first.second).isEqualTo(PuyoColor.BLUE)
        Truth.assertThat(info.nextColor.second.first).isEqualTo(PuyoColor.YELLOW)
        Truth.assertThat(info.nextColor.second.second).isEqualTo(PuyoColor.YELLOW)
        Truth.assertThat(info.currentMainPos.row).isEqualTo(1)
        Truth.assertThat(info.currentMainPos.column).isEqualTo(3)
        Truth.assertThat(info.currentSubPos.row).isEqualTo(0)
        Truth.assertThat(info.currentSubPos.column).isEqualTo(3)
